...
.. note::
   ...
   Конструктор Яндекс Карт не умеет работать с `мультиполигонами <https://yandex.ru/support/maps-builder/concept/markers_5.html#markers_5__GeoJSON_import>`_, т.е. полигонами которые состоят из нескольких частей.
