...
2. Дождитесь получения результата, `скачайте <https://data.nextgis.com/ru/orders/actual/>`_ и **распакуйте** архив с данными.

3. Создайте макет:

Откройте файл проекта в `NextGIS QGIS <https://nextgis.ru/nextgis-qgis/>`_ или обычном QGIS.
