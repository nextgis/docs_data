...
* Конвертируйте желаемый слой или слои в формат KML. Для конвертации можно воспользоваться любым онлайн конвертером, например, |location_link| или использовать `пересохранение слоя <https://docs.nextgis.ru/docs_ngqgis/source/map.html#ngqgis-map-save-vector>`_ в NextGIS QGIS в формат KML.
