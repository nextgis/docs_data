...
Если вы выбрали регион из каталога, то вы увидите карточки продуктов, доступных для этого региона. Выберите нужную.

.. figure:: _static/data_type_select_cards_ru.png
   :name: 
   :align: center
   :width: 20cm

   Карточки продуктов на странице региона

Вы попадёте на страницу конкретного продукта. Такая же страница отображается, если выбирать произвольную область.

Чтобы перейти к другому продукту, воспользуйтесь выпадающим меню.

.. figure:: _static/data_type_select_dropdown_ru.png
   :name: 
   :align: center
   :width: 20cm
