...
5. Теперь перейдите на https://data.nextgis.com/ru/orders/actual/. Справа должна быть синяя кнопка **Войти**. Нажмите её. Вы будете авторизованы под адресом, который ввели на my.nexgis.com.
