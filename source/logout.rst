...
.. note:: Не используйте вариант "Войти с помощью Google", даже если вы заказали данные на почту @gmail.com. Вместо этого просто введите адрес электронной почты.
