# -*- coding: utf-8 -*- 
#
# NextGIS Data documentation build configuration file
...
latex_documents = [
  (master_doc, 'NextGISData.tex', u'Документация по NextGIS Data',
   author, 'manual', 'true'),
]
...
texinfo_documents = [
  (master_doc, 'NextGISServies', u'NextGISServies',
   author, 'NextGISServies', 'One line description of project.',
   'Miscellaneous'),
]
